...
<script type="text/javascript">
	...
	$(function() {
		$('#allteaslist').datagrid({
			...
			striped : true,//条纹显示效果
			url : '${baseurl}course/couteas/allteaslist_result.action?cid=${cid}',//加载数据的连接，引连接请求过来是json数据
...
<form id="sysuseraddform" action="${baseurl}course/couteas/addcoutea_submit.action" method="post">
