...
<SCRIPT type="text/javascript">
	...
	//登录后台方法
	function tobackfirst() {
		
		
			location.href = '${baseurl}backfirst.action';
...
<BODY style="overflow-y: hidden;" class="easyui-layout" scroll="no" >
	<DIV
		...
		<SPAN style="padding-right: 20px; float: right;" class="head">
			...
			&nbsp;&nbsp;
			<A title='修改密码' ref='modifypwd' href="#" rel='${baseurl}teacher/modifypwd.action' icon='icon-null' id="modifypwd" >修改密码</A>
			&nbsp;&nbsp;
			<A id="tobackfirst" href=javascript:tobackfirst()>登录后台</A>
			&nbsp;&nbsp;
			<A id="loginOut" href=javascript:logout()>退出系统</A>

		</SPAN> <SPAN style="padding-left: 10px; font-size: 16px;"><IMG
			align="absmiddle" src="${baseurl}images/blocks.gif" width="20" height="20">
			教研室信息管理系统</SPAN> <SPAN style="padding-left: 15px;" id="News"></SPAN>
	</DIV>
